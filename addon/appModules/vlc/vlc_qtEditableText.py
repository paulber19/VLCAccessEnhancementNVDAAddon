...
class QTEditableText(EditableTextWithAutoSelectDetection):
	...
	def script_selectNextCh(self, gesture):
		...
		if sizeAfter > sizeBefore:
			...
			if self.value and self.fakeCaret < len(self.value): speech.speakText(_("deselected"))
		self.displayBraille()
...
class VLCQTEditableText(QTEditableText):
	...
	def initOverlayClass(self):
		...
		if self.language not in SpecialAlphanumeric:
			...
			#TRANSLATORS: This string should not be translated literally. Should be a list of the special characters that are considered to be alphanumeric in your local alphabet, for example the Ò in Spanish.
